$(function () {
    ...
    var clientpub = "ca-games-pub-2717734642802423";
    var ad_channel = "8404625207";

    if (clientpub == "None") {
        adsRequest.adTagUrl = "";
    } else if (clientpub == 'demo') {
        adsRequest.adTagUrl = 'https://googleads.g.doubleclick.net/pagead/ads?ad_type=video_text_image&client=ca-games-pub-2717734642802423&description_url=http%3A%2F%2Fxwz.51dz.top%2Fxwz%2F&channel=8404625207&hl=en&max_ad_duration=30000';
    } else {
        adsRequest.adTagUrl =
