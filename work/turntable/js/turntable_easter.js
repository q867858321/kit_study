...
var options = {
  awards: [{
      id: 105,
      name: 'Gift basket',
      imgurl: '/turntable/images-easter/gift-basket-200x200.webp'
    },
    {
      id: 101,
      name: 'Makeup kit',
      imgurl: '/turntable/images-easter/make-up-kit-200x200.webp'
    },
    {
      id: 103,
      name: 'Vacation',
      imgurl: '/turntable/images-easter/vacation-200x200.webp'
    },
    {
      id: 0,
      name: 'Thanks',
      imgurl: '/turntable/images-easter/thanks-200x200.webp'
    },
    {
      id: 104,
      name: 'Chocolate box',
      imgurl: '/turntable/images-easter/chocolate-box_200x200.webp'
    },
    {
      id: 102,
      name: 'Mobile Phone',
      imgurl: '/turntable/images-easter/phone-200x200.webp'
    },
  ],
  bgColor: '#FF821B',
...
langsList.on('click', 'li', function (e) {
  ...
  updateLang(lang)
  langsList.hide()
  if (window.hippoo) hippoo.setStore({
    lang: lang
  })
})
...
function playTable() {
  return hippoo.api('user/turntable', {
...
function initNums() {
  ...
  return hippoo.api('user/syncturntable', {
    ...
    records: _playRecords.map(function (t) {
