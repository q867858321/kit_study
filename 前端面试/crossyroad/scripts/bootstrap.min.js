(function (modules) {
  ...
  15: function (module, exports) {
    ...
    LoadingBar.prototype.setProgress = function (currentPhaseProgress, notPoki) {
      ...
      if (!notPoki) {
        PokiSDK.gameLoadingProgress({ percentageDone: this.progress });
      }
    };
  ...
  53: function (module, exports, __webpack_require__) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var FadeHelper = __webpack_require__(42);
  ...
  58: function (module, exports, __webpack_require__) {
    var _Storage = __webpack_require__(1);
    var _Storage2 = _interopRequireDefault(_Storage);
    var _HipsterWhale = __webpack_require__(53);
    var _HipsterWhale2 = _interopRequireDefault(_HipsterWhale);
    var _LoadingScreen = __webpack_require__(54);
    var _LoadingScreen2 = _interopRequireDefault(_LoadingScreen);
    var _PokiPreroll = __webpack_require__(55);
    ...
    var _Detector = __webpack_require__(43);
    ...
    function loadGame() {
      ...
      switchWorld = function switchWorld(worldName) {
        return function () {
          ...
          sendMessage(messageDefinitions.worldSwitchedTo, worldName);
          console.log('Switching platform to: ' + worldName);
        };
      };
      var requestCurrentWorld = function requestCurrentWorld() {
        sendMessage(messageDefinitions.requestCurrentWorld);
      };
      ...
      var receivedWorldSwitch = function receivedWorldSwitch(worldName) {
        console.log("Switch World");
        if (worldName.worldName === "original") {
          worldName.worldName = "original_cast";
        }
        if (!AssetLoader.isWorldLoaded(worldName.worldName)) {
          AssetLoader.add.json('models/' + worldName.worldName + '-char.json');
          AssetLoader.add.json('models/' + worldName.worldName + '-world.json');
          AssetLoader.worlds[worldName.worldName].loading = true;
          AssetLoader.load(function () {
            console.log("Switch world done");
            if (worldName.worldName === "original_cast") {
              _Storage2.default.setItem('selectedChar', 0);
            } else if (worldName.worldName === 'space') {
              _Storage2.default.setItem('selectedChar', 5);
            }
            _Storage2.default.setItem('currentWorld', worldName.worldName);
          });
        }
      };
      ...
      receiveMessage = function receiveMessage(event) {
        ...
        case messageDefinitions.receiveCurrentWorld:
          initializeWorld(event.data.content);
          break;
        case messageDefinitions.switchWorldTo:
          receivedWorldSwitch(event.data.content);
          break;
        }
      };
      ...
      window.mobileUpsellAvatarURL = 'upsell-phone.png';
      AssetLoader.add.image(window.mobileUpsellAvatarURL);
      AssetLoader.loadGeneric('upsell-text.txt', function (receivedText) {
        window.mobileUpsellText = receivedText.split(';');
      });
      AssetLoader.add.json('models/common-world.json');
      if (_Utils2.default.getQueryVariable('world')) {
        if (_Utils2.default.getQueryVariable('world') === 'space') {
          _Storage2.default.setItem('currentWorld', 'space');
          _Storage2.default.setItem('selectedChar', 5);
        } else if (_Utils2.default.getQueryVariable('world') === 'original') {
          _Storage2.default.setItem('currentWorld', 'original_cast');
          _Storage2.default.setItem('selectedChar', 0);
        }
      }
      if (_Storage2.default.getItem('currentWorld') === 'original_cast') {
        AssetLoader.add.json('models/original_cast-world.json');
        AssetLoader.add.json('models/original_cast-char.json');
      } else {
        AssetLoader.add.json('models/space-world.json');
        AssetLoader.add.json('models/space-char.json');
        if (_Storage2.default.getItem('currentWorld') === null) {
          _Storage2.default.setItem('selectedChar', 5);
          _Storage2.default.setItem('currentWorld', 'space');
        }
      }
