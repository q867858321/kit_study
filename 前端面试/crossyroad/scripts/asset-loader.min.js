(function (modules) {
  ...
  57: function (module, exports) {
    ...
    AssetLoader.add.text = function (asset) {
      AssetLoader.assetsLoading.push(asset);
      AssetLoader.push(function (done) {
        loadJSON(asset, function (response) {
          AssetLoader.done(asset, response);
