...
<el-collapse v-model="controlList">
  <el-form ref="dataForm" v-if="spObj" v-model="spObj">
  		<el-collapse-item name="1">
  			...
  			<TableGame :timeId='timeId' v-if="value4" @choiceData="choiceData" :selectId="spObj.content"/>
			<TablePage :timeId='timeId' v-if="!value4" @choiceData="choiceData"  :selectId="spObj.content"/>
  		</el-collapse-item>
