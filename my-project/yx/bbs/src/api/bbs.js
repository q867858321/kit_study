 ...
 * }
 */
export function primeTopic(params){
  return fetch({
    url: '/manage/topic/prime',
    method: 'post',
    data: params
  })
}
 ...
 * }
 */
export function topTopic(params){
  return fetch({
    url: '/manage/topic/top',
    method: 'post',
    data: params
  })
}
 ...
 * }
 */
export function shieldTopic(params){
  return fetch({
    url: '/manage/topic/shield',
    method: 'post',
    data: params
  })
}
